...
public class UpdateVisitHandler(IApplicationDbContext dbContext) : ICommandHandler<UpdateVisitCommand, UpdateVisitResult>
{
    ...
    {
        visit.UpdateVisit(visitDto.StartDate,visitDto.EndDate, visitDto.PatientId,visitDto.Title,visitDto.TypeVisit,visitDto.LocationVisit, visitDto.Duration,visitDto.Description,visitDto.Availability);
    }
}
